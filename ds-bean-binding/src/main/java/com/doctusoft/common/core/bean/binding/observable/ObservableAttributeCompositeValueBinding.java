...
public class ObservableAttributeCompositeValueBinding<Source, Target> extends ObservableCompositeValueBinding<Source, Target>
	...
	private final ObservableProperty<? super Source, Target> attribute;
	private Source sourceValue = null;
	private ListenerRegistration sourceValueHandler = null;

	public ObservableAttributeCompositeValueBinding(ObservableValueBinding<? extends Source> sourceBinding, ObservableProperty<? super Source, Target> attribute) {
		super(sourceBinding);
